...
// SpotLight
const spotLight = new THREE.SpotLight('#fff', 3.6, 10, Math.PI * 0.3);
...
// PointLight
const pointLight = new THREE.PointLight('#fff', 2.3);
...
gui.add(sphere.position, 'y').min(0.2).max(2).step(0.01).name('Sphere y');
